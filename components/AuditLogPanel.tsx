...
<head>
<meta charset="UTF-8">
<title>Privacy Session Report — Photography Coach</title>
<style>
...
<p class="subtitle">Photography Coach · Vault Mode · Generated ${dateStr} at ${timeStr}</p>
...
<p class="footer">
  This report was generated by Photography Coach (Vault Mode). Vault Mode blocks network connections during analysis. This document can be provided to clients as evidence of confidential handling.
</p>
